...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    loop = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/Lenovo/Documents/WIN 2024-25/PSY-416_PY_EMOTIONS/416_conditions_research.xlsx'),
        seed=None, name='loop')
